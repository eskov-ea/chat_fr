...
class MessagesRepository  {
  ...
  Future <void> deleteMessage({required userId, required messageId}) => messagesProvider.deleteMessage(userId: userId, messageId: messageId);
  Future <void> updateMessageStatuses({required dialogId}) => messagesProvider.updateMessageStatuses(dialogId: dialogId);
  Future <int?> createDialogSendMessage({required userId, required partnerId, required message}) => messagesProvider.createDialogAndSendMessage(userId: userId, partnerId: partnerId, message: message);
